...
<body>
	...
	<section id="content">
		<div
			class="record-list col-md-12 col-lg-12 col-sm-12">
			<div class="row">
				<div class="other-choices col-md-3 col-lg-3 col-sm-3">

				</div>
				<div class="filter-items col-md-6 col-lg-6 col-sm-6 p-0">
					<c:set var="i" value="{1,3,2,3,4,3,2,3,4,2,1,3,1}" />
					<c:forEach items="${i}">
					<div class="item col-md-4 col-lg-4 col-sm-4">
						<div class="item-content">
						<img alt="" src="/static/images/college_dp.jpg" />
						<ul class="d-flex">
							<li><a href="#" class="btn-view">Open</a></li>
