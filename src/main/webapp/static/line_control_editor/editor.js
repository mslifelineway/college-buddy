...
// hiding image icon to adding images (ALL METHODS FOR INSERTING IMAGE) HIDDEN
						   'insert_img'	: { "modal": true,
											...
											//comment upto here for hiding image icon to adding images (ALL METHODS FOR INSERTING IMAGE) HIDDEN
                ...
                'togglescreen': {"text": "Toggle Screen",
                    ...
                    "custom": function (button, parameters) {
                        ...
                        if ($(this).data("editor").parent().hasClass('fullscreen')) {
                            $("#header").css("display", "none"); // HIDING HEADER WHEN SCREEN IS FULLSCREEN
                            $(this).data("editor").css({"height": $(this).data("editor").parent().height() - ($(this).data("menuBar").height() + statusdBarHeight) - 13});
                        } else {
                            $("#header").css("display", "block");// DISPLAYING HEADER WHEN SCREEN IS NOT FULLSCREEN
            ...
            var settings = $.extend({
                ...
                'insert_link': true,
                'unlink': true,
				'insert_img':true, // hiding image icon to adding images
                'hr_line': true,
                'block_quote': true,
                'source': true,
                'strikeout': true,
            ...
            if (settings['status_bar']) {
                editor.keyup(function (event) {
                    ...
                    $(editor_Content).data("statusBar").append('<div class="label domain-title">' + 'Welcome To College-Buddy' + '</div>');
                });
            }
